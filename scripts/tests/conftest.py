"""Shared pytest fixtures for FoodClaw L1 unit tests."""
import os
import sys
...
import pytest
from food_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with core + foodclaw schema."""
...
@pytest.fixture
def env(conn):
    """Full food service environment: company, accounts, FY, CC, employees, supplier."""
